	...
	<form name="frm">
		<table>
			...
			<tr>
				...
				<td><input type="password" name="pass" id="pass" value="${vo.pass }">
				</td>
			</tr>
			<tr>
				<th><label for="name">이름</label></th>
				<td><input type="text" name="name" id="name" placeholder="이름" value="${vo.name }">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="tel" id="tel" placeholder="예):010-0000-0000" value="${vo.tel }"> 
				</td>
			</tr>
			<tr>
